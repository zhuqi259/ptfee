...
<title>OA办公自动化平台 - 工作流文件管理主界面</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		/*	oTable = $("#activityList").dataTable({
				...
				"bServerSide" : true,
				"sAjaxSource" : "system/activity!activityList.action", //本查询返回两列数据：ID、name列
				"oLanguage" : {
					"sProcessing" : "正在处理...",
					"sZeroRecords" : "没有用户数据",
					"sEmptyTable" : "没有用户数据",
	...
	function openAuth() {
		...
		if (activityId) {
			$("#rightFrame").attr("src",
					"system/activity!updateInput.action?id=" + activityId);
		}
	}
					...
					<thead>
						<tr>
							...
							<th height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">选择节点进行文件管理</span>
								</div></th>
						</tr>
					</thead>
