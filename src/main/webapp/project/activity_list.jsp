...
<title>OA办公自动化平台 - 工作流查看主界面</title>
...
<script type="text/javascript">
	...
	$(function() {
		...
		oTable = $("#activityList").dataTable({
			...
			"bServerSide" : true,
			"sAjaxSource" : "<%=basePath%>system/activity!activityPage.action", //本查询返回两列数据：ID、name列
			"oLanguage" : {
				"sProcessing" : "正在处理...",
	...
	function openAuth() {
		...
		if (activityId) {
			$("#rightFrame").attr("src",
					"system/project!activity.action?activityId=" + activityId+"&id="+${id});
					...
					<thead>
						<tr>
							...
							<th height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">选择节点查看工程进度</span>
								</div>
							</th>
						</tr>
					</thead>
