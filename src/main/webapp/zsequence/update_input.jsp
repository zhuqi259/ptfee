...
<body>
	...
	<div id="formwrapper">
		<h3>请设置属性信息</h3>
		<form action="system/fieldMap.action" method="post">
			<input type="hidden" name="method:update" value=""> <input
				type="hidden" name="id" value="<s:property value="id"/>">
			<fieldset>
				<legend>请设置属性信息 </legend>
				<div>
					<label for="name">属性标识</label> <input type="text" name="name"
						id="name" value="${name }" size="30" readonly="readonly"
						required="required" /> <br />
				</div>

				<div>
					<label for="displayName">属性名称</label> <input type="text"
						name="displayName" id="displayName" value="${displayName }"
						required="required" size="30" /> <br />
				</div>
