...
<div id="formwrapper">
	...
	<fieldset>
		<legend>部门基本信息
		<input type="button" value="添加下级部门" onclick="window.location = '<%=basePath%>system/department!addInput.action?parent.id=${id}'"/>
		<input type="button" value="添加岗位" onclick="window.location = '<%=basePath%>system/position!addInput.action?parent.id=${id}'"/>
		<input type="button" value="添加人员" onclick="window.location = '<%=basePath%>system/person!addInput.action?parent.id=${id}'"/>
		<input type="button" value="删除本部门" onclick="window.location = '<%=basePath%>system/department!del.action?id=${id}'"/>
		</legend>
		<div>
