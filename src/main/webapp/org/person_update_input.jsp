	...
	<div id="formwrapper">
		...
		<form action="system/person.action" method="post"
			...
			<fieldset>
				...
				<div>
					<label for="snumber">员工编号</label> <input type="text" name="snumber"
						id="snumber" value="${snumber }" size="30" /> <br />
				</div>
				<div>
					<label for="sex">性别</label> <input type="text" name="sex" id="sex"
						value="${sex }" size="30" /> <br />
				</div>
				<div>
					<label for="phone">手机</label> <input type="text" name="phone"
						id="phone" value="${phone }" size="30" /> <br />
				</div>
				<div>
					<label for="qq">QQ号</label> <input type="text" name="qq" id="qq"
						value="${qq }" size="30" /> <br />
				</div>
				<div>
					<label for="msn">MSN</label> <input type="text" name="msn" id="msn"
						value="${msn }" size="30" /> <br />
				</div>
				<div>
				...
				<div>
					<label for="duty">主要负责</label> <input type="text" name="duty"
						id="duty" value="${duty }" size="60" /> <br />
				</div>
				<div>
