...
<body>
	...
	<div id="formwrapper">
		<h3>请设置文件信息</h3>
		<form action="system/zfile.action" method="post">
			<input type="hidden" name="method:add" value=""> <input
				type="hidden" name="activity.id"
				value="<s:property value="activity.id"/>">
			<fieldset>
				<legend>请设置文件信息 </legend>
				<div>
					<label for="name">文件名称</label> <input type="text" name="name"
						id="name" value="${name }" size="30" /> <br />
				</div>


				<div>
					<label for="databases" style="size: 200px">选择七库</label> 
					<select
						name="base.id">
